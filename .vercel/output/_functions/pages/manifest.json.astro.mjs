import { a as getImage } from '../chunks/_astro_assets_SX68lusP.mjs';
import { i as icon } from '../chunks/icon_BWcGMiNn.mjs';
...
const maskableIcon = new Proxy({"src":"/_astro/icon-maskable.C1A7b-dw.png","width":1024,"height":1024,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/icon-maskable.png";
							}
