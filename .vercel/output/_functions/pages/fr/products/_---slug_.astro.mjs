...
async function getStaticPaths() {
  ...
  return productEntries.map((product) => {
    const slugWithoutLang = product.slug.replace(/^fr\//, "");
    return {
...
}, "/Users/josesantiz-dev/Desktop/ScrewFast/src/pages/fr/products/[...slug].astro", void 0);

const $$file = "/Users/josesantiz-dev/Desktop/ScrewFast/src/pages/fr/products/[...slug].astro";
const $$url = "/fr/products/[...slug]";
