const id = "fr/item-a765.md";
						const collection = "products";
						const slug = "fr/item-a765";
						const body = "";
						const data = {title:"SF-AB A765",description:"Ensemble de Vis Assorties",main:{id:2,content:"Découvrez l'ensemble de vis assorties SF-AB A765 – la solution ultime pour vos besoins de fixation. Ce set complet comprend une grande variété de vis soigneusement sélectionnées pour aborder divers projets avec facilité et précision.\n",imgCard:
						new Proxy({"src":"/_astro/product-image-2.BcjkuUps.avif","width":1458,"height":1042,"format":"avif","fsPath":"/Users/josesantiz-dev/Desktop/ScrewFast/src/images/product-image-2.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/product-image-2.avif";
							}
					...
					,second:
						new Proxy({"src":"/_astro/blueprint-2.DSItIwt1.avif","width":1920,"height":1080,"format":"avif","fsPath":"/Users/josesantiz-dev/Desktop/ScrewFast/src/images/blueprint-2.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/blueprint-2.avif";
							}
						...
						const _internal = {
							type: 'content',
							filePath: "/Users/josesantiz-dev/Desktop/ScrewFast/src/content/products/fr/item-a765.md",
							rawData: undefined,
						};
