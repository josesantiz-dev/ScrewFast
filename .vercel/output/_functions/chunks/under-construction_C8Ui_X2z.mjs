import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderComponent } from './astro/server_DhNoaUZN.mjs';
import 'kleur/colors';
...
}, "/Users/josesantiz-dev/Desktop/ScrewFast/src/components/ui/blocks/MainSection.astro", void 0);
...
}, "/Users/josesantiz-dev/Desktop/ScrewFast/src/components/ui/blocks/LeftSection.astro", void 0);
...
}, "/Users/josesantiz-dev/Desktop/ScrewFast/src/components/ui/blocks/RightSection.astro", void 0);
...
}, "/Users/josesantiz-dev/Desktop/ScrewFast/src/components/ui/blocks/StatsBig.astro", void 0);
...
}, "/Users/josesantiz-dev/Desktop/ScrewFast/src/components/ui/blocks/StatsSmall.astro", void 0);
...
}, "/Users/josesantiz-dev/Desktop/ScrewFast/src/components/sections/features/FeaturesStats.astro", void 0);
...
const blueprints = new Proxy({"src":"/_astro/blueprints-image.DxAt2gto.avif","width":1333,"height":2000,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/blueprints-image.avif";
							}
...
const personWorking = new Proxy({"src":"/_astro/person-working.aUGgRiE_.avif","width":1334,"height":2000,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/person-working.avif";
							}
...
const beforeAfter = new Proxy({"src":"/_astro/before-after.BntBToq6.avif","width":2048,"height":1366,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/before-after.avif";
							}
...
const constructionWorkers = new Proxy({"src":"/_astro/construction-workers.XhU7Ouf4.avif","width":1920,"height":1280,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/construction-workers.avif";
							}
...
const aerialView = new Proxy({"src":"/_astro/aerial-view.CeV30CXX.avif","width":1920,"height":1282,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/aerial-view.avif";
							}
...
const usingTools = new Proxy({"src":"/_astro/using-tools.BrEE8t5H.avif","width":1920,"height":1280,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/using-tools.avif";
							}
...
const progressBuilding = new Proxy({"src":"/_astro/progress-building.Cjca0suI.avif","width":1920,"height":2560,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/progress-building.avif";
							}
...
const underConstruction = new Proxy({"src":"/_astro/under-construction.DfISh1yq.avif","width":1920,"height":2876,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/under-construction.avif";
							}
