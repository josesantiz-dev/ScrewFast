const id = "fr/item-f303.md";
						const collection = "products";
						const slug = "fr/item-f303";
						const body = "";
						const data = {title:"SF-FN F303",description:"Boulons hexagonaux",main:{id:4,content:"Découvrez les boulons hexagonaux SF-FN F303 – le choix parfait pour les applications de fixation lourdes. Conçus avec précision et durabilité, ces boulons hexagonaux offrent la force et la fiabilité dont vous avez besoin pour vos projets les plus exigeants.\n",imgCard:
						new Proxy({"src":"/_astro/product-image-4.D9xSELbd.avif","width":1458,"height":1042,"format":"avif","fsPath":"/Users/josesantiz-dev/Desktop/ScrewFast/src/images/product-image-4.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/product-image-4.avif";
							}
					...
					,imgMain:
						new Proxy({"src":"/_astro/product-image-main-4.Bkgr1GB5.avif","width":1737,"height":1151,"format":"avif","fsPath":"/Users/josesantiz-dev/Desktop/ScrewFast/src/images/product-image-main-4.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/josesantiz-dev/Desktop/ScrewFast/src/images/product-image-main-4.avif";
							}
					...
					,second:
						...
						const _internal = {
							type: 'content',
							filePath: "/Users/josesantiz-dev/Desktop/ScrewFast/src/content/products/fr/item-f303.md",
							rawData: undefined,
						};
